...
const getCalendarClient = async (userId: string): Promise<calendar_v3.Calendar | null> => {
    try {
        ...
        const credentials = user.googleCalendarToken as unknown as CalendarCredentials;
        const oauth2Client = createOAuth2Client();
...
export const setReminder = async (
    ...
    try {
        ...
        // TODO: Insert into reminders collection in Appwrite
...
export const triggerFollowup = async (
    ...
    try {
        ...
        // TODO: Insert into followups collection in Appwrite
        // await databases.createDocument(DATABASE_ID, 'followups', ID.unique(), {
        //     userId,
