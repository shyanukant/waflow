...
import type { ConversationDocument } from '../db/collections.js';
    ...
    try {
        ...
        const result = await databases.listDocuments(
            ...
            [
                ...
                Query.limit(1000) // Appwrite default limit
            ]
        );

        const allConversations = result.documents as unknown as ConversationDocument[];
